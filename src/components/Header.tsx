    ...
    return (
        <header className="flex items-center px-6 py-4 justify-between sticky top-0 bg-background-light/90 dark:bg-background-dark/90 backdrop-blur-md z-10 transition-colors duration-200">
            ...
            <button
                ...
                className="flex size-10 shrink-0 items-center justify-center rounded-full bg-transparent text-[#181811] dark:text-white hover:bg-black/5 dark:hover:bg-white/10 transition-colors"
            >
